...
class SURV_Agent:
    ...
    def create_report_html(self, OS_summary, PFS_summary):
        ...
        if isinstance(OS_summary, pd.DataFrame):
            ...
            OS_summary_html = OS_summary.to_html(classes="table table-bordered", border=0.1, index=False)
        if isinstance(PFS_summary, pd.DataFrame):
            ...
            PFS_summary_html = PFS_summary.to_html(classes="table table-bordered", border=0.1, index=False)
